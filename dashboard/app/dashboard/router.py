"""
dashboard/app/dashboard/router.py
...
# React SPA built output directory (populated by the Node.js build stage)
...
def _spa_index(inject_script: str = "") -> HTMLResponse:
    ...
    if not _INDEX.exists():
        return HTMLResponse(
            ...
            "<p>Run <code>npm run build</code> inside <code>react/</code> "
